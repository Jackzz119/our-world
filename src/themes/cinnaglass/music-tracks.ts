...
export const TRACKS: Track[] = [
    {
        ...
        chord: [0, 4, 7, 11],
        dur: 214,
        cover: 'linear-gradient(145deg,#FCE3B0,#F5B774)'
    },
    {
        title: '雨天的窗边',
        artist: 'Lo-fi 时光',
        ...
        chord: [0, 3, 7, 10],
        dur: 198,
        cover: 'linear-gradient(145deg,#BFD0F2,#8C9DDB)'
    },
    {
        title: '暖灯电台',
        artist: '夜晚频率',
        ...
        chord: [0, 4, 7, 11],
        dur: 236,
        cover: 'linear-gradient(145deg,#E7C4F0,#B68FD9)'
    },
    {
        title: '一起散步',
        artist: '周末',
        ...
        chord: [0, 5, 7, 12],
        dur: 188,
        cover: 'linear-gradient(145deg,#BFE8D2,#86C9A6)'
    }
];

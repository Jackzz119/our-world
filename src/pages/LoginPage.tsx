        ...
        <main className="min-h-screen flex items-center justify-center bg-linear-to-br from-purple-50 to-pink-50 p-4">
            <section className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
                ...
                <div className="flex items-center my-4">
                    ...
                    <span className="mx-3 text-sm text-gray-400">或</span>
                    <hr className="flex-1 border-gray-200" />
                </div>

                <button
                    className="w-full border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-3 rounded-lg transition flex items-center justify-center gap-2"
                    type="button"

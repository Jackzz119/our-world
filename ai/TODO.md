...
- [ ] 物件功能卡收敛：房间与双角色保持可辨，统一跨场景材质；夜灯玻璃已实装，但用户反馈视觉还原与全系统一致性仍需重设计
    - [~] **双页日记与共用 UI 材质提案**（2026-09-06 新一轮）：已出亚麻 / 苔绿 / 烟褐三款，含导航、花园对照与翻页分镜；推荐苔绿，待用户评审。统一色调、其他功能复用与连续翻页研究已登记 `ai/design_system/cinnaglass/journal-book-directions/codex-report.md`，本轮未改产品代码；批准后再安排实施与其他弹窗迁移

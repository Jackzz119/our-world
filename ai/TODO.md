...
- [x] **设计技能与资料库重构**（2026-09-13 修订）：UI Tailor 与 Monet 跨平台职责、常驻 design-system/角色/场景/物件/效果/UI Markdown，素材地址由项目跟踪；concept/research 分工明确，回合报告和迁移临时文件清理；过程验证在 session 汇报
